import s0, { forwardRef as I0, useState as Y, useEffect as o0, useCallback as W0, useRef as $0, useContext as E1, Fragment as R1, createElement as B1 } from "react";
...
const G = /* @__PURE__ */ new Map(), B0 = /* @__PURE__ */ new Map(), T1 = ["backup:started", "backup:completed", "backup:failed"];
let S0 = !1;
function D1() {
  if (!S0) {
    S0 = !0;
...
function N1(a, n) {
  let i = G.get(a);
  i || (i = /* @__PURE__ */ new Set(), G.set(a, i)), i.add(n);
}
function I1(a, n) {
  var i;
  (i = G.get(a)) == null || i.delete(n);
}
function W1(a, n, i) {
  N1(n, i);
  let s = B0.get(a);
  s || (s = [], B0.set(a, s)), s.push({ event: n, handler: i }), D1();
}
var t0 = { exports: {} }, O = {};
/**
 * @license React
...
function $1() {
  if (P0) return O;
  P0 = 1;
  var a = s0, n = Symbol.for("react.element"), i = Symbol.for("react.fragment"), s = Object.prototype.hasOwnProperty, t = a.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, l = { key: !0, ref: !0, __self: !0, __source: !0 };
  function w(x, A, C) {
    var b, h = {}, _ = null, D = null;
    C !== void 0 && (_ = "" + C), A.key !== void 0 && (_ = "" + A.key), A.ref !== void 0 && (D = A.ref);
    for (b in A) s.call(A, b) && !l.hasOwnProperty(b) && (h[b] = A[b]);
    if (x && x.defaultProps) for (b in A = x.defaultProps, A) h[b] === void 0 && (h[b] = A[b]);
    return { $$typeof: n, type: x, key: _, ref: D, props: h, _owner: t.current };
  }
...
function U1() {
  return j0 || (j0 = 1, process.env.NODE_ENV !== "production" && function() {
    var a = s0, n = Symbol.for("react.element"), i = Symbol.for("react.portal"), s = Symbol.for("react.fragment"), t = Symbol.for("react.strict_mode"), l = Symbol.for("react.profiler"), w = Symbol.for("react.provider"), x = Symbol.for("react.context"), A = Symbol.for("react.forward_ref"), C = Symbol.for("react.suspense"), b = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), _ = Symbol.for("react.lazy"), D = Symbol.for("react.offscreen"), n0 = Symbol.iterator, q0 = "@@iterator";
    function z0(r) {
    ...
    var J0 = !1, Q0 = !1, X0 = !1, r1 = !1, e1 = !1, l0;
    l0 = Symbol.for("react.module.reference");
    function a1(r) {
      return !!(typeof r == "string" || typeof r == "function" || r === s || r === l || e1 || r === t || r === C || r === b || r1 || r === D || J0 || Q0 || X0 || typeof r == "object" && r !== null && (r.$$typeof === _ || r.$$typeof === h || r.$$typeof === w || r.$$typeof === x || r.$$typeof === A || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
      r.$$typeof === l0 || r.getModuleId !== void 0));
    }
    function t1(r, e, o) {
      var c = r.displayName;
      if (c)
    ...
    function L(r) {
      ...
      if (typeof r == "object")
        switch (r.$$typeof) {
          case x:
            var e = r;
            return i0(e) + ".Consumer";
          case w:
            var o = r;
            return i0(o._context) + ".Provider";
          case A:
            return t1(r, r.render, "ForwardRef");
          case h:
            var c = r.displayName || null;
            return c !== null ? c : L(r.type) || "Memo";
          case _: {
    ...
    var k = Object.assign, P = 0, c0, u0, g0, v0, f0, d0, p0;
    function w0() {
    }
    ...
    function s1() {
      {
        if (P === 0) {
          c0 = console.log, u0 = console.info, g0 = console.warn, v0 = console.error, f0 = console.group, d0 = console.groupCollapsed, p0 = console.groupEnd;
          var r = {
            configurable: !0,
            enumerable: !0,
            value: w0,
    ...
    var z = R.ReactCurrentDispatcher, K;
    function F(r, e, o) {
      {
        if (K === void 0)
          try {
...
`), y = c.stack.split(`
`), m = u.length - 1, Z = y.length - 1; m >= 1 && Z >= 0 && u[m] !== y[Z]; )
            Z--;
          for (; m >= 1 && Z >= 0; m--, Z--)
            if (u[m] !== y[Z]) {
              if (m !== 1 || Z !== 1)
...
` + u[m].replace(" at new ", " at ");
                    return r.displayName && M.includes("<anonymous>") && (M = M.replace("<anonymous>", r.displayName)), typeof r == "function" && N.set(r, M), M;
                  }
                while (m >= 1 && Z >= 0);
              break;
            }
        ...
        J = !1, z.current = d, o1(), Error.prepareStackTrace = f;
      }
      var S = r ? r.displayName || r.name : "", E = S ? F(S) : "";
      return typeof r == "function" && N.set(r, E), E;
    }
    function l1(r, e, o) {
      return h0(r, !1);
    }
    ...
    var j = Object.prototype.hasOwnProperty, m0 = {}, x0 = R.ReactDebugCurrentFrame;
    function W(r) {
      if (r) {
        var e = r._owner, o = I(r.type, r._source, e ? e.type : null);
        x0.setExtraStackFrame(o);
      } else
          ...
          if (d(r, v)) {
            ...
            try {
              if (typeof r[v] != "function") {
                var y = Error((c || "React class") + ": " + o + " type `" + v + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof r[v] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
    ...
    function Z0(r) {
      if (v1(r))
        return H("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", g1(r)), A0(r);
    }
    var b0 = R.ReactCurrentOwner, f1 = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function w1(r, e) {
      typeof r.ref == "string" && b0.current;
    }
    function h1(r, e) {
      {
        var o = function() {
          _0 || (_0 = !0, H("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", e));
        };
    ...
    function m1(r, e) {
      {
        var o = function() {
          H0 || (H0 = !0, H("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", e));
        };
    ...
    function A1(r, e, o, c, f) {
      {
        var d, v = {}, u = null, y = null;
        o !== void 0 && (Z0(o), u = "" + o), p1(e) && (Z0(e.key), u = "" + e.key), d1(e) && (y = e.ref, w1(e, f));
        for (d in e)
          j.call(e, d) && !f1.hasOwnProperty(d) && (v[d] = e[d]);
        if (r && r.defaultProps) {
        ...
        return x1(r, u, y, f, c, b0.current, v);
      }
    }
    var X = R.ReactCurrentOwner, y0 = R.ReactDebugCurrentFrame;
    function B(r) {
      if (r) {
        var e = r._owner, o = I(r.type, r._source, e ? e.type : null);
        y0.setExtraStackFrame(o);
      } else
    ...
    function M0(r, e) {
      {
        ...
        C0[o] = !0;
        var c = "";
        r && r._owner && r._owner !== X.current && (c = " It was passed a child from " + L(r._owner.type) + "."), B(r), H('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', o, c), B(null);
      }
    }
    function L0(r, e) {
      {
    ...
    function H1(r) {
      {
        for (var e = Object.keys(r.props), o = 0; o < e.length; o++) {
          var c = e[o];
          if (c !== "children" && c !== "key") {
            B(r), H("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", c), B(null);
            break;
          }
        }
        r.ref !== null && (B(r), H("Invalid attribute `ref` supplied to `React.Fragment`."), B(null));
      }
    }
    var k0 = {};
    function E0(r, e, o, c, f, d) {
      {
        var v = a1(r);
        if (!v) {
          var u = "";
          ...
          y ? u += y : u += V0();
          var m;
          r === null ? m = "null" : Q(r) ? m = "array" : r !== void 0 && r.$$typeof === n ? (m = "<" + (L(r.type) || "Unknown") + " />", u = " Did you accidentally export a JSX literal instead of a component?") : m = typeof r, H("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", m, u);
        }
        var Z = A1(r, e, o, f, d);
        if (Z == null)
          return Z;
        ...
        if (j.call(e, "key")) {
          var E = L(r), V = Object.keys(e).filter(function(k1) {
            return k1 !== "key";
          }), a0 = V.length > 0 ? "{key: someKey, " + V.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!k0[E + a0]) {
            var L1 = V.length > 0 ? "{" + V.join(": ..., ") + ": ...}" : "{}";
            H(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, a0, E, L1, E), k0[E + a0] = !0;
          }
        }
        return r === s ? H1(Z) : _1(Z), Z;
      }
    }
    function y1(r, e, o) {
      return E0(r, e, o, !0);
    ...
    var C1 = V1, M1 = y1;
    T.Fragment = s, T.jsx = C1, T.jsxs = M1;
  }()), T;
}
process.env.NODE_ENV === "production" ? t0.exports = $1() : t0.exports = U1();
var p = t0.exports;
const Y1 = {
...
function U0({ name: a, className: n = "", size: i = 20, title: s }) {
  const t = V2[a], l = {
...
const E2 = C2, G0 = M2, R2 = L2, B2 = k2;
function S2({ className: a = "", children: n, ...i }) {
  return /* @__PURE__ */ p.jsx("div", { className: Y0([E2, a]), ...i, children: n });
}
const P2 = I0(function({ className: n = "", children: i, ...s }, t) {
  return /* @__PURE__ */ p.jsx("div", { ref: t, className: Y0([R2, n]), ...s, children: i });
});
function F2({
  open: a,
  onClose: n,
  ...
  const [w, x] = Y(!1), [A, C] = Y(!1);
  o0(() => {
    if (a)
      C(!0), x(!1);
    else if (A) {
      x(!0);
      const _ = setTimeout(() => C(!1), 180);
      return () => clearTimeout(_);
    }
  }, [a]);
  const b = W0(() => {
    x(!0), setTimeout(() => n(), 150);
  }, [n]);
  if (!A) return null;
  const h = /* @__PURE__ */ p.jsx(
    "div",
    {
      className: `fixed inset-0 z-50 flex items-center justify-center soft-backdrop ${w ? "animate-fade-out" : "animate-fade-in"}`,
      onClick: (_) => {
        _.target === _.currentTarget && b();
      },
      children: /* @__PURE__ */ p.jsxs(
        S2,
        {
          className: `relative w-[300px] rounded-[20px] shadow-[20px_20px_30px_rgba(0,0,0,0.068)] flex flex-col items-center gap-5 p-[30px] ${w ? "animate-fade-out" : "animate-scale-in"} ${l}`,
          ...
          children: [
            /* @__PURE__ */ p.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ p.jsx(U0, { name: "close", size: 20, className: "text-[#afafaf] group-hover:text-black dark:group-hover:text-white transition-colors" })
              }
            ),
            /* @__PURE__ */ p.jsxs("div", { className: "w-full flex flex-col gap-[5px]", children: [
              i && /* @__PURE__ */ p.jsx("p", { className: "text-[20px] font-bold text-[rgb(27,27,27)] dark:text-foreground", children: i }),
              /* @__PURE__ */ p.jsx("div", { className: "font-light text-[rgb(102,102,102)] dark:text-muted-foreground", children: s })
            ] }),
            t && /* @__PURE__ */ p.jsx("div", { className: "w-full flex items-center justify-center gap-[10px]", children: t })
          ]
        }
      )
    }
  );
  return S1(h, document.body);
}
function N2({
  options: a,
  value: n,
  ...
  var C, b;
  const [l, w] = Y(!1), x = $0(null), A = ((C = a.find((h) => h.value === n)) == null ? void 0 : C.label) || ((b = a[0]) == null ? void 0 : b.label) || "";
  return o0(() => {
    if (!l) return;
    const h = (_) => {
      x.current && !x.current.contains(_.target) && w(!1);
    };
    return document.addEventListener("mousedown", h), () => document.removeEventListener("mousedown", h);
  }, [l]), /* @__PURE__ */ p.jsxs("div", { ref: x, className: `relative z-[100] select-none w-fit ${t}`.trim(), children: [
    /* @__PURE__ */ p.jsxs(
      "div",
      {
        onClick: () => w(!l),
        "data-open": l ? "true" : "false",
        className: `${G0} flex items-center justify-between gap-2 border border-foreground/20 px-3 py-[5px] rounded text-xs cursor-pointer min-w-[100px] text-foreground`,
        children: [
    ...
    "label",
    {
      ...
      children: /* @__PURE__ */ p.jsx(
        "input",
        {
          ...
          step: i,
          value: s,
          onChange: (x) => t(Number(x.target.value)),
    ...
    return /* @__PURE__ */ p.jsx(
      "input",
      {
        ...
        className: [
          ...
          `${G0} text-foreground placeholder:text-muted-foreground`,
...
const U2 = {
  ...
  useRef: $0,
  useState: Y
}, j2 = 1, Y2 = ["core.read", "core.backup", "events", "ui", "music"], $ = [], U = [], q = /* @__PURE__ */ new Map();
function G2(a) {
  for (let n = $.length - 1; n >= 0; n--)
    $[n].pluginId === a && $.splice(n, 1);
  for (let n = U.length - 1; n >= 0; n--)
    U[n].pluginId === a && U.splice(n, 1);
}
async function q2(a) {
  const n = q.get(a) ?? [], i = [];
  for (const s of n)
...
function K2(a, n) {
  ...
  return {
    ...
    ui: {
      registerPage(t) {
        s("ui", "ui.registerPage"), $.push({ pluginId: a, ...t });
      },
      registerSettingsSection(t) {
        s("ui", "ui.registerSettingsSection"), U.push({ pluginId: a, ...t });
      },
      notify(t) {
        s("ui", "ui.notify");
      }
...
export {
  ...
  U2 as default,
  $ as registeredPages,
  U as registeredSettingsSections,
