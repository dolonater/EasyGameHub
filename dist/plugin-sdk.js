...
import { Fragment as w8, createElement as f8, useCallback as m8, useContext as h8, useEffect as _8, useRef as x8, useState as A8 } from "react";
import { createPortal as z0 } from "react-dom";
import { createPortal as Z8 } from "react-dom";
function F1(t, o = !1) {
...
function G1() {
  ...
  function s(g, m, L) {
    ...
    L !== void 0 && (H = "" + L), m.key !== void 0 && (H = "" + m.key), m.ref !== void 0 && (h = m.ref);
    for (A in m) r.call(m, A) && !i.hasOwnProperty(A) && (y[A] = m[A]);
    if (g && g.defaultProps) for (A in m = g.defaultProps, m) y[A] === void 0 && (y[A] = m[A]);
...
function z1() {
  return N0 || (N0 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function X0(e, a, c) {
      {
        ...
        p !== "" && (a += "%s", c = c.concat([p]));
        var w = c.map(function(d) {
          return String(d);
        });
        w.unshift("Warning: " + a), Function.prototype.apply.call(console[e], console, w);
      }
    }
    var i1 = !1, e1 = !1, r1 = !1, l1 = !1, t1 = !1, v0;
    v0 = Symbol.for("react.module.reference");
    function a1(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === r || e === i || t1 || e === l || e === L || e === A || l1 || e === h || i1 || e1 || r1 || typeof e == "object" && e !== null && (e.$$typeof === H || e.$$typeof === y || e.$$typeof === s || e.$$typeof === g || e.$$typeof === m || // This needs to include all possible module reference object
    ...
    var B = Object.assign, F = 0, g0, p0, w0, f0, m0, h0, _0;
    function x0() {
    }
    ...
    function s1() {
      {
        if (F === 0) {
          g0 = console.log, p0 = console.info, w0 = console.warn, f0 = console.error, m0 = console.group, h0 = console.groupCollapsed, _0 = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: x0,
...
`), V = u.stack.split(`
`), _ = v.length - 1, x = V.length - 1; _ >= 1 && x >= 0 && v[_] !== V[x]; )
            x--;
          for (; _ >= 1 && x >= 0; _--, x--)
            if (v[_] !== V[x]) {
              if (_ !== 1 || x !== 1)
...
` + v[_].replace(" at new ", " at ");
        ...
        e0 = !1, X.current = w, n1(), Error.prepareStackTrace = p;
      }
          ...
          if (w(e, d)) {
            ...
            try {
              if (typeof e[d] != "function") {
                var V = Error((u || "React class") + ": " + c + " type `" + d + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof e[d] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw V.name = "Invariant Violation", V;
              }
              v = e[d](a, d, u, c, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (_) {
              v = _;
            }
            v && !(v instanceof Error) && (q(p), Z("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", u || "React class", c, d, typeof v), q(null)), v instanceof Error && !(v.message in y0) && (y0[v.message] = !0, q(p), Z("Failed %s type: %s", c, v.message), q(null));
          }
      }
    }
    ...
    function y1(e, a, c, u, p) {
      {
        var w, d = {}, v = null, V = null;
        c !== void 0 && (C0(c), v = "" + c), m1(a) && (C0(a.key), v = "" + a.key), f1(a) && (V = a.ref, h1(a, p));
        for (w in a)
          D.call(a, w) && !w1.hasOwnProperty(w) && (d[w] = a[w]);
        if (e && e.defaultProps) {
        ...
        return A1(e, v, V, p, u, H0.current, d);
      }
    }
...
const Ne = "app-surface app-glass-floating", Ie = "app-surface app-glass-control", $e = "app-surface app-glass-floating", We = "app-glass-menu-item";
function Q0(t) {
  return t.filter(Boolean).join(" ");
}
const Ue = Ne, J0 = Ie, Ye = $e, qe = We;
function Ge({ className: t = "", children: o, ...n }) {
  return /* @__PURE__ */ f.jsx("div", { className: Q0([Ue, t]), ...n, children: o });
}
const ze = q0(function({ className: o = "", children: n, ...r }, l) {
  return /* @__PURE__ */ f.jsx("div", { ref: l, className: Q0([Ye, o]), ...r, children: n });
});
function l8({
  open: t,
  onClose: o,
          ...
          children: [
            /* @__PURE__ */ f.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ f.jsx(K0, { name: "close", size: 20, className: "text-[#afafaf] group-hover:text-black dark:group-hover:text-white transition-colors" })
              }
            ),
            /* @__PURE__ */ f.jsxs("div", { className: `w-full flex flex-col gap-[5px] ${s === "lg" ? "min-h-0 overflow-y-auto" : ""}`, children: [
              h.title && /* @__PURE__ */ f.jsx("p", { className: "text-[20px] font-bold text-[rgb(27,27,27)] dark:text-foreground", children: h.title }),
              /* @__PURE__ */ f.jsx("div", { className: "font-light text-[rgb(102,102,102)] dark:text-muted-foreground", children: h.children })
            ] }),
            h.actions && /* @__PURE__ */ f.jsx("div", { className: "w-full flex items-center justify-center gap-[10px]", children: h.actions })
          ]
        }
      )
    }
...
function t8({
  ...
  var y, H;
  const [i, s] = $(!1), g = u0(null), [m, L] = $(null), A = ((y = t.find((h) => h.value === o)) == null ? void 0 : y.label) || ((H = t[0]) == null ? void 0 : H.label) || "";
  return b0(() => {
    if (!i) return;
    const h = () => {
      const R = g.current;
    ...
    z0(
      /* @__PURE__ */ f.jsx(
        ze,
        {
          ...
          style: m ? { left: m.left, top: m.top, width: m.width } : void 0,
          children: t.map((h) => /* @__PURE__ */ f.jsx(
            "button",
            {
              ...
              className: [
                `${qe} text-left rounded px-3 py-[5px] text-xs transition-colors duration-300`,
...
function s8({ on: t, onChange: o, id: n }) {
  const r = n || c0.useId();
  return /* @__PURE__ */ f.jsxs("div", { className: "relative inline-block w-[42px] h-[22px]", children: [
    /* @__PURE__ */ f.jsx(
      "input",
      {
        id: r,
...
const n8 = {
  ...
  useRef: u0,
  useState: $
}, Ke = 1, c8 = ["core.read", "core.backup", "events", "ui", "music", "bilibili"];
  ...
  return {
    ...
    bilibili: {
      ...
      cache: {
        ...
        async coverProxyUrl(i) {
          return r("bilibili", "bilibili.cache.coverProxyUrl"), i ? `http://127.0.0.1:${await l("bilibili_proxy_port")}/bilibili/cover/${Je(i)}?url=${encodeURIComponent(i)}` : "";
        }
      },
      ranking: {
        videos(i) {
...
export {
  ...
  s8 as Toggle,
  Ke as apiVersion,
  v8 as clearPluginDispose,
  u8 as clearPluginRegistrations,
  f8 as createElement,
  d8 as createPluginSdk,
  Z8 as createPortal,
  n8 as default,
  z as registeredPages,
  K as registeredSettingsSections,
  b8 as runPluginDispose,
  m8 as useCallback,
  h8 as useContext,
  _8 as useEffect,
  x8 as useRef,
