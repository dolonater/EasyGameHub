...
import { Fragment as oi, createElement as si, useCallback as ni, useContext as ci, useEffect as ui, useRef as vi, useState as gi } from "react";
  ...
  if (n)
    for (const i of Array.from(n))
      try {
        ...
        console.error(`[plugins:events] handler for "${t}" threw:`, a);
      }
}
function U1(t, o) {
  let n = K.get(t);
...
function G1() {
  if (F0) return F;
  F0 = 1;
  var t = n0, o = Symbol.for("react.element"), n = Symbol.for("react.fragment"), i = Object.prototype.hasOwnProperty, a = t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, r = { key: !0, ref: !0, __self: !0, __source: !0 };
  function s(b, h, H) {
    var A, m = {}, C = null, k = null;
    H !== void 0 && (C = "" + H), h.key !== void 0 && (C = "" + h.key), h.ref !== void 0 && (k = h.ref);
    for (A in h) i.call(h, A) && !r.hasOwnProperty(A) && (m[A] = h[A]);
    if (b && b.defaultProps) for (A in h = b.defaultProps, h) m[A] === void 0 && (m[A] = h[A]);
    return { $$typeof: o, type: b, key: C, ref: k, props: m, _owner: a.current };
  }
...
function z1() {
  return D0 || (D0 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function J0(e, l, c) {
      {
        ...
        f.unshift("Warning: " + l), Function.prototype.apply.call(console[e], console, f);
      }
    }
    var X0 = !1, e1 = !1, r1 = !1, i1 = !1, t1 = !1, v0;
    v0 = Symbol.for("react.module.reference");
    function a1(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === i || e === r || t1 || e === a || e === H || e === A || i1 || e === k || X0 || e1 || r1 || typeof e == "object" && e !== null && (e.$$typeof === C || e.$$typeof === m || e.$$typeof === s || e.$$typeof === b || e.$$typeof === h || // This needs to include all possible module reference object
    ...
    function R(e) {
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          ...
          case C: {
            var p = e, f = p._payload, d = p._init;
            try {
              return R(d(f));
            } catch {
              return null;
    ...
    var E = Object.assign, j = 0, d0, b0, p0, f0, w0, m0, h0;
    function _0() {
    }
    ...
    function o1() {
      {
        if (j === 0) {
          d0 = console.log, b0 = console.info, p0 = console.warn, f0 = console.error, w0 = console.group, m0 = console.groupCollapsed, h0 = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: _0,
...
` + g[_].replace(" at new ", " at ");
    ...
    function U(e) {
      if (e) {
        var l = e._owner, c = W(e.type, e._source, l ? l.type : null);
        y0.setExtraStackFrame(c);
      } else
        y0.setExtraStackFrame(null);
    }
    function v1(e, l, c, u, p) {
      {
        ...
        for (var d in e)
          if (f(e, d)) {
            ...
            try {
              ...
              g = e[d](l, d, u, c, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (_) {
              g = _;
            }
            g && !(g instanceof Error) && (U(p), y("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", u || "React class", c, d, typeof g), U(null)), g instanceof Error && !(g.message in A0) && (A0[g.message] = !0, U(p), y("Failed %s type: %s", c, g.message), U(null));
          }
      }
    }
    ...
    function h1(e, l) {
      {
        var c = function() {
          C0 || (C0 = !0, y("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", l));
        };
    ...
    function _1(e, l) {
      {
        var c = function() {
          M0 || (M0 = !0, y("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", l));
        };
    ...
    function A1(e, l, c, u, p) {
      {
        var f, d = {}, g = null, Z = null;
        c !== void 0 && (V0(c), g = "" + c), w1(l) && (V0(l.key), g = "" + l.key), f1(l) && (Z = l.ref, m1(l, p));
        for (f in l)
          T.call(l, f) && !p1.hasOwnProperty(f) && (d[f] = l[f]);
        if (e && e.defaultProps) {
        ...
        return x1(e, g, Z, p, u, H0.current, d);
      }
    }
    ...
    function E0(e, l) {
      {
        ...
        R0[c] = !0;
        var u = "";
        e && e._owner && e._owner !== t0.current && (u = " It was passed a child from " + R(e._owner.type) + "."), P(e), y('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', c, u), P(null);
      }
    }
    function S0(e, l) {
      {
        ...
        if (i0(e))
          ...
          if (typeof p == "function" && p !== e.entries)
            for (var f = p.call(e), d; !(d = f.next()).done; )
              l0(d.value) && E0(d.value, l);
        }
      }
    }
    function V1(e) {
    ...
    function P0(e, l, c, u, p, f) {
      {
        ...
        if (!d) {
          ...
          Z ? g += Z : g += L0();
          var _;
          e === null ? _ = "null" : i0(e) ? _ = "array" : e !== void 0 && e.$$typeof === o ? (_ = "<" + (R(e.type) || "Unknown") + " />", g = " Did you accidentally export a JSX literal instead of a component?") : _ = typeof e, y("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", _, g);
        }
        var x = A1(e, l, c, p, f);
        if (x == null)
          return x;
        ...
        if (T.call(l, "key")) {
          var S = R(e), V = Object.keys(l).filter(function(E1) {
            return E1 !== "key";
...
const Fr = q0(function({ className: o = "", children: n, ...i }, a) {
  return /* @__PURE__ */ w.jsx("div", { ref: a, className: K0([Or, o]), ...i, children: n });
});
function qr({
  open: t,
  onClose: o,
  ...
  const [b, h] = z(!1), [H, A] = z(!1), m = c0(null);
  u0(() => {
    if (t)
      A(!0), h(!1);
    else if (H) {
  ...
  if (!H) return null;
  t && (m.current = { title: n, children: i, actions: a });
  const k = m.current ?? { title: n, children: i, actions: a }, N = s === "lg" ? "w-[min(92vw,680px)] max-h-[85vh]" : "w-[300px]", J = /* @__PURE__ */ w.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ w.jsxs(
        Tr,
        {
          className: `relative ${N} rounded-[20px] shadow-[20px_20px_30px_rgba(0,0,0,0.068)] flex flex-col items-center gap-5 p-[30px] ${b ? "animate-fade-out" : "animate-scale-in"} ${r}`,
...
function Gr({
  ...
  var H, A;
  const [r, s] = z(!1), b = c0(null), h = ((H = t.find((m) => m.value === o)) == null ? void 0 : H.label) || ((A = t[0]) == null ? void 0 : A.label) || "";
  return u0(() => {
    if (!r) return;
    const m = (C) => {
  ...
  }, [r]), /* @__PURE__ */ w.jsxs("div", { ref: b, className: `relative z-[100] select-none w-fit ${a}`.trim(), children: [
    /* @__PURE__ */ w.jsxs(
      "div",
      {
        onClick: () => s(!r),
    ...
    /* @__PURE__ */ w.jsx(
      Fr,
      {
        ...
        children: t.map((m) => /* @__PURE__ */ w.jsx(
          "button",
          {
            onClick: () => {
              n(m.value), s(!1);
            ...
            className: [
              ...
              o === m.value ? "bg-secondary font-medium" : ""
            ].join(" "),
            children: m.label
          },
          m.value
...
const Kr = q0(
  function({ className: o = "", density: n = "default", ...i }, a) {
    return /* @__PURE__ */ w.jsx(
      "input",
      {
        ref: a,
...
function ti(t, o) {
  ...
  return {
    ...
    music: {
      ...
      loginCellphone(r, s, b) {
        return i("music", "music.loginCellphone"), v("music_login_cellphone", { phone: r, captcha: s, countrycode: b });
      },
      loginStatus() {
      ...
      playlistTracksRange(r, s, b) {
        return i("music", "music.playlistTracksRange"), v("music_playlist_tracks_range", { id: r, start: s, count: b });
      },
      songUrl(r, s) {
    ...
    bilibili: {
      account: {
        loginQrKey() {
          return i("bilibili", "bilibili.account.loginQrKey"), a("bilibili_login_qr_key");
        },
        loginQrCheck(r) {
          return i("bilibili", "bilibili.account.loginQrCheck"), a("bilibili_login_qr_check", { key: r });
        },
        loginStatus() {
          return i("bilibili", "bilibili.account.loginStatus"), a("bilibili_login_status");
        },
        logout() {
          return i("bilibili", "bilibili.account.logout"), a("bilibili_logout");
        }
      },
      home: {
        recommendVideos(r, s) {
          return i("bilibili", "bilibili.home.recommendVideos"), a("bilibili_recommend_videos", { page: r, refresh: s });
        },
        searchVideos(r, s, b) {
          return i("bilibili", "bilibili.home.searchVideos"), a("bilibili_search_videos", { keywords: r, page: s, refresh: b });
        },
        popularVideos(r, s) {
          return i("bilibili", "bilibili.home.popularVideos"), a("bilibili_popular_videos", { page: r, refresh: s });
        }
      },
      video: {
        detail(r) {
          return i("bilibili", "bilibili.video.detail"), a("bilibili_video_detail", r);
        },
        related(r) {
          return i("bilibili", "bilibili.video.related"), a("bilibili_related_videos", r);
        },
        openExternal(r) {
          return i("bilibili", "bilibili.video.openExternal"), a("bilibili_open_video", { bvid: r });
        }
      },
      playback: {
        proxyPort() {
          return i("bilibili", "bilibili.playback.proxyPort"), a("bilibili_proxy_port");
        },
        createPlayback(r) {
          return i("bilibili", "bilibili.playback.createPlayback"), a("bilibili_create_playback", r);
        },
        saveLocalProgress(r) {
          return i("bilibili", "bilibili.playback.saveLocalProgress"), a("bilibili_save_local_progress", r);
        },
        loadLocalProgress(r) {
          return i("bilibili", "bilibili.playback.loadLocalProgress"), a("bilibili_load_local_progress", r);
        },
        reportProgress(r) {
          return i("bilibili", "bilibili.playback.reportProgress"), a("bilibili_report_progress", r);
        }
      },
      danmaku: {
        list(r) {
          return i("bilibili", "bilibili.danmaku.list"), a("bilibili_danmaku_list", r);
        },
        segment(r) {
          return i("bilibili", "bilibili.danmaku.segment"), a("bilibili_danmaku_segment", r);
        },
        thumbup(r) {
          return i("bilibili", "bilibili.danmaku.thumbup"), a("bilibili_danmaku_thumbup", r);
        },
        report(r) {
          return i("bilibili", "bilibili.danmaku.report"), a("bilibili_danmaku_report", r);
        },
        recall(r) {
          return i("bilibili", "bilibili.danmaku.recall"), a("bilibili_danmaku_recall", r);
        },
        send(r) {
          return i("bilibili", "bilibili.danmaku.send"), a("bilibili_send_danmaku", r);
        }
      },
      comment: {
        list(r) {
          return i("bilibili", "bilibili.comment.list"), a("bilibili_comment_list", r);
        },
        replies(r) {
          return i("bilibili", "bilibili.comment.replies"), a("bilibili_comment_replies", r);
        },
        add(r) {
          return i("bilibili", "bilibili.comment.add"), a("bilibili_comment_add", r);
        },
        like(r) {
          return i("bilibili", "bilibili.comment.like"), a("bilibili_comment_like", r);
        },
        dislike(r) {
          return i("bilibili", "bilibili.comment.dislike"), a("bilibili_comment_dislike", r);
        },
        delete(r) {
          return i("bilibili", "bilibili.comment.delete"), a("bilibili_comment_delete", r);
        },
        top(r) {
          return i("bilibili", "bilibili.comment.top"), a("bilibili_comment_top", r);
        },
        report(r) {
          return i("bilibili", "bilibili.comment.report"), a("bilibili_comment_report", r);
        }
      },
      library: {
        historyList(r) {
          return i("bilibili", "bilibili.library.historyList"), a("bilibili_history_list", { page: r });
        },
        toViewList() {
          return i("bilibili", "bilibili.library.toViewList"), a("bilibili_toview_list");
        },
        addToView(r) {
          return i("bilibili", "bilibili.library.addToView"), a("bilibili_toview_add", r);
        },
        removeToView(r) {
          return i("bilibili", "bilibili.library.removeToView"), a("bilibili_toview_remove", r);
        },
        favoriteFolders(r) {
          return i("bilibili", "bilibili.library.favoriteFolders"), a("bilibili_favorite_folders", { rid: r });
        },
        favoriteItems(r, s) {
          return i("bilibili", "bilibili.library.favoriteItems"), a("bilibili_favorite_items", { mediaId: r, page: s });
        },
        favoriteVideo(r) {
          return i("bilibili", "bilibili.library.favoriteVideo"), a("bilibili_favorite_video", {
            rid: r.rid,
      ...
      interaction: {
        state(r) {
          return i("bilibili", "bilibili.interaction.state"), a("bilibili_interaction_state", r);
        },
        like(r) {
          return i("bilibili", "bilibili.interaction.like"), a("bilibili_like_video", r);
        },
        coin(r) {
          return i("bilibili", "bilibili.interaction.coin"), a("bilibili_coin_video", r);
        },
        favorite(r) {
          return i("bilibili", "bilibili.interaction.favorite"), a("bilibili_favorite_video_interaction", {
            rid: r.rid,
            addMediaIds: r.addMediaIds ?? [],
            delMediaIds: r.delMediaIds ?? []
          });
        ...
        toView(r) {
          return i("bilibili", "bilibili.interaction.toView"), a("bilibili_toview_video_interaction", r);
        },
        followOwner(r) {
          return i("bilibili", "bilibili.interaction.followOwner"), a("bilibili_follow_owner", r);
        },
        copyShareLink(r) {
          return i("bilibili", "bilibili.interaction.copyShareLink"), a("bilibili_copy_share_link", r);
        },
        openReport(r) {
          return i("bilibili", "bilibili.interaction.openReport"), a("bilibili_open_report", r);
        }
      },
      cache: {
        saveScreenshot(r) {
          return i("bilibili", "bilibili.cache.saveScreenshot"), a("bilibili_save_screenshot", r);
        },
        openScreenshotFolder() {
          return i("bilibili", "bilibili.cache.openScreenshotFolder"), a("bilibili_open_screenshot_folder");
        },
        clearCache() {
          return i("bilibili", "bilibili.cache.clearCache"), a("bilibili_clear_cache");
        },
        async coverProxyUrl(r) {
          return i("bilibili", "bilibili.cache.coverProxyUrl"), r ? `http://127.0.0.1:${await a("bilibili_proxy_port")}/bilibili/cover/${Ir(r)}?url=${encodeURIComponent(r)}` : "";
        }
      },
      ranking: {
        videos(r) {
          return i("bilibili", "bilibili.ranking.videos"), a("bilibili_ranking_videos", { rid: r });
        },
        weeks() {
          return i("bilibili", "bilibili.ranking.weeks"), a("bilibili_weekly_series_list");
        },
        weekDetail(r) {
          return i("bilibili", "bilibili.ranking.weekDetail"), a("bilibili_weekly_series_one", { number: r });
        },
        precious() {
          return i("bilibili", "bilibili.ranking.precious"), a("bilibili_precious_videos");
        }
      },
      search: {
        suggest(r) {
          return i("bilibili", "bilibili.search.suggest"), a("bilibili_search_suggest", { keyword: r });
        },
        hotwords() {
          return i("bilibili", "bilibili.search.hotwords"), a("bilibili_search_hotwords");
        }
      },
      fav: {
        createFolder({ title: r }) {
          return i("bilibili", "bilibili.fav.createFolder"), a("bilibili_fav_folder_create", { title: r });
        },
        editFolder({ mediaId: r, title: s }) {
          return i("bilibili", "bilibili.fav.editFolder"), a("bilibili_fav_folder_edit", { mediaId: r, title: s });
        },
        deleteFolders({ mediaIds: r }) {
          return i("bilibili", "bilibili.fav.deleteFolders"), a("bilibili_fav_folder_delete", { mediaIds: r });
        },
        deleteResources({ mediaId: r, resources: s }) {
          return i("bilibili", "bilibili.fav.deleteResources"), a("bilibili_fav_resource_delete", { mediaId: r, resources: s });
        },
        moveResources({ srcMediaId: r, tarMediaId: s, resources: b }) {
          return i("bilibili", "bilibili.fav.moveResources"), a("bilibili_fav_resource_move", { srcMediaId: r, tarMediaId: s, resources: b });
        },
        copyResources({ srcMediaId: r, tarMediaId: s, resources: b }) {
          return i("bilibili", "bilibili.fav.copyResources"), a("bilibili_fav_resource_copy", { srcMediaId: r, tarMediaId: s, resources: b });
        },
        cleanResources({ mediaId: r }) {
          return i("bilibili", "bilibili.fav.cleanResources"), a("bilibili_fav_resource_clean", { mediaId: r });
        }
      },
      user: {
        space({ mid: r }) {
          return i("bilibili", "bilibili.user.space"), a("bilibili_user_space", { mid: r });
        },
        videos({ mid: r, page: s }) {
          return i("bilibili", "bilibili.user.videos"), a("bilibili_user_videos", { mid: r, page: s });
        },
        follow({ mid: r, follow: s }) {
          return i("bilibili", "bilibili.user.follow"), a("bilibili_user_follow", { mid: r, follow: s });
        }
      },
      season: {
        detail({ seasonId: r }) {
          return i("bilibili", "bilibili.season.detail"), a("bilibili_season_detail", { seasonId: r });
        },
        follow({ seasonId: r, follow: s }) {
          return i("bilibili", "bilibili.season.follow"), a("bilibili_season_follow", { seasonId: r, follow: s });
        },
        pgcTabs({ kind: r }) {
          return i("bilibili", "bilibili.season.pgcTabs"), a("bilibili_pgc_tabs", { kind: r });
        },
        pgcRank({ seasonType: r }) {
          return i("bilibili", "bilibili.season.pgcRank"), a("bilibili_pgc_rank", { seasonType: r });
        },
        followList({ page: r, cinema: s }) {
          return i("bilibili", "bilibili.season.followList"), a("bilibili_bangumi_follow_list", { page: r, cinema: s });
        }
      },
      live: {},
      dynamic: {},
