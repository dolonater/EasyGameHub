...
function z1() {
  return D0 || (D0 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var E = Object.assign, j = 0, d0, p0, f0, b0, w0, h0, m0;
    function _0() {
    }
...
function t8(t, o) {
  ...
  return {
    ...
    bilibili: {
      ...
      season: {
        detail({ seasonId: r }) {
          return i("bilibili", "bilibili.season.detail"), l("bilibili_season_detail", { seasonId: r });
        },
        follow({ seasonId: r, follow: s }) {
          return i("bilibili", "bilibili.season.follow"), l("bilibili_season_follow", { seasonId: r, follow: s });
        },
        pgcTabs({ kind: r }) {
          return i("bilibili", "bilibili.season.pgcTabs"), l("bilibili_pgc_tabs", { kind: r });
        },
        pgcRank({ seasonType: r }) {
          return i("bilibili", "bilibili.season.pgcRank"), l("bilibili_pgc_rank", { seasonType: r });
        },
        followList({ page: r, cinema: s }) {
          return i("bilibili", "bilibili.season.followList"), l("bilibili_bangumi_follow_list", { page: r, cinema: s });
        }
      },
      live: {},
      dynamic: {},
