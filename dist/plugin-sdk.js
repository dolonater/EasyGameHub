...
import { Fragment as oi, createElement as si, useCallback as ni, useContext as ci, useEffect as ui, useRef as di, useState as vi } from "react";
...
function G1() {
  if (F0) return F;
  F0 = 1;
  var t = n0, o = Symbol.for("react.element"), n = Symbol.for("react.fragment"), i = Object.prototype.hasOwnProperty, l = t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, e = { key: !0, ref: !0, __self: !0, __source: !0 };
  function s(b, h, H) {
    var A, w = {}, C = null, M = null;
    H !== void 0 && (C = "" + H), h.key !== void 0 && (C = "" + h.key), h.ref !== void 0 && (M = h.ref);
    for (A in h) i.call(h, A) && !e.hasOwnProperty(A) && (w[A] = h[A]);
    ...
    function J0(r, a, c) {
      {
        ...
        f.unshift("Warning: " + a), Function.prototype.apply.call(console[r], console, f);
      }
    }
    var X0 = !1, e1 = !1, r1 = !1, i1 = !1, t1 = !1, d0;
    d0 = Symbol.for("react.module.reference");
    function l1(r) {
      return !!(typeof r == "string" || typeof r == "function" || r === i || r === e || t1 || r === l || r === H || r === A || i1 || r === M || X0 || e1 || r1 || typeof r == "object" && r !== null && (r.$$typeof === C || r.$$typeof === w || r.$$typeof === s || r.$$typeof === b || r.$$typeof === h || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
      r.$$typeof === d0 || r.getModuleId !== void 0));
    }
    function a1(r, a, c) {
      var u = r.displayName;
      if (u)
    ...
    function R(r) {
      ...
      if (typeof r == "object")
        switch (r.$$typeof) {
          ...
          case h:
            return a1(r, r.render, "ForwardRef");
          case w:
            var u = r.displayName || null;
            return u !== null ? u : R(r.type) || "Memo";
          case C: {
            var p = r, f = p._payload, g = p._init;
            try {
              return R(g(f));
            } catch {
              return null;
...
` + v[_].replace(" at new ", " at ");
                    return r.displayName && k.includes("<anonymous>") && (k = k.replace("<anonymous>", r.displayName)), typeof r == "function" && $.set(r, k), k;
                  }
                while (_ >= 1 && x >= 0);
              break;
            }
        ...
        r0 = !1, X.current = f, s1(), Error.prepareStackTrace = p;
      }
      var O = r ? r.displayName || r.name : "", S = O ? I(O) : "";
      return typeof r == "function" && $.set(r, S), S;
    }
    function c1(r, a, c) {
      return x0(r, !1);
    }
      ...
      if (typeof r == "object")
        switch (r.$$typeof) {
          ...
          case w:
            return W(r.type, a, c);
          case C: {
            var u = r, p = u._payload, f = u._init;
            try {
              return W(f(p), a, c);
            } catch {
            }
    ...
    function U(r) {
      if (r) {
        var a = r._owner, c = W(r.type, r._source, a ? a.type : null);
        y0.setExtraStackFrame(c);
      } else
        y0.setExtraStackFrame(null);
    }
    function d1(r, a, c, u, p) {
      {
          ...
          if (f(r, g)) {
            ...
            try {
              if (typeof r[g] != "function") {
                var Z = Error((u || "React class") + ": " + c + " type `" + g + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof r[g] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw Z.name = "Invariant Violation", Z;
              }
              v = r[g](a, g, u, c, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (_) {
              v = _;
            }
    ...
    function V0(r) {
      if (b1(r))
        return y("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", g1(r)), Z0(r);
    }
    ...
    function w1(r, a) {
      typeof r.ref == "string" && H0.current;
    }
    function h1(r, a) {
      {
        var c = function() {
    ...
    function A1(r, a, c, u, p) {
      {
        ...
        return x1(r, v, Z, p, u, H0.current, g);
      }
    }
    var t0 = B.ReactCurrentOwner, M0 = B.ReactDebugCurrentFrame;
    function P(r) {
      if (r) {
        var a = r._owner, c = W(r.type, r._source, a ? a.type : null);
    ...
    function E0(r, a) {
      {
        ...
        R0[c] = !0;
        var u = "";
        r && r._owner && r._owner !== t0.current && (u = " It was passed a child from " + R(r._owner.type) + "."), P(r), y('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', c, u), P(null);
      }
    }
    function S0(r, a) {
      {
        ...
        if (i0(r))
          ...
          if (typeof p == "function" && p !== r.entries)
            for (var f = p.call(r), g; !(g = f.next()).done; )
    ...
    function V1(r) {
      {
        ...
        if (c) {
          var u = R(a);
          d1(c, r.props, "prop", u, r);
        } else if (a.PropTypes !== void 0 && !l0) {
          l0 = !0;
          var p = R(a);
    ...
    function H1(r) {
      {
        for (var a = Object.keys(r.props), c = 0; c < a.length; c++) {
          var u = a[c];
          if (u !== "children" && u !== "key") {
            P(r), y("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", u), P(null);
            break;
          }
        }
        r.ref !== null && (P(r), y("Invalid attribute `ref` supplied to `React.Fragment`."), P(null));
      }
    }
    var B0 = {};
    function P0(r, a, c, u, p, f) {
      {
        var g = l1(r);
        if (!g) {
          var v = "";
          ...
          Z ? v += Z : v += L0();
          var _;
          r === null ? _ = "null" : i0(r) ? _ = "array" : r !== void 0 && r.$$typeof === o ? (_ = "<" + (R(r.type) || "Unknown") + " />", v = " Did you accidentally export a JSX literal instead of a component?") : _ = typeof r, y("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", _, v);
        }
        var x = A1(r, a, c, p, f);
        if (x == null)
          return x;
        ...
        if (T.call(a, "key")) {
          var S = R(r), V = Object.keys(a).filter(function(E1) {
            return E1 !== "key";
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`, o0, S, R1, S), B0[S + o0] = !0;
    ...
    var M1 = k1, L1 = C1;
    D.Fragment = i, D.jsx = M1, D.jsxs = L1;
  }()), D;
}
...
const Rr = "app-surface app-glass-floating", Er = "app-surface app-glass-control", Sr = "app-surface app-glass-floating", Br = "app-glass-menu-item";
function K0(t) {
  return t.filter(Boolean).join(" ");
}
const Pr = Rr, Q0 = Er, Or = Sr, jr = Br;
function Tr({ className: t = "", children: o, ...n }) {
  return /* @__PURE__ */ m.jsx("div", { className: K0([Pr, t]), ...n, children: o });
}
const Fr = q0(function({ className: o = "", children: n, ...i }, l) {
  return /* @__PURE__ */ m.jsx("div", { ref: l, className: K0([Or, o]), ...i, children: n });
});
function qr({
  open: t,
  onClose: o,
  ...
  if (!H) return null;
  t && (w.current = { title: n, children: i, actions: l });
  const M = w.current ?? { title: n, children: i, actions: l }, N = s === "lg" ? "w-[min(92vw,680px)] max-h-[85vh]" : "w-[300px]", J = /* @__PURE__ */ m.jsx(
    "div",
    {
...
function ti(t, o) {
  ...
  return {
    ...
    ui: {
      registerPage(e) {
        i("ui", "ui.registerPage"), q.push({ pluginId: t, ...e });
      },
      registerSettingsSection(e) {
        i("ui", "ui.registerSettingsSection"), G.push({ pluginId: t, ...e });
      },
      notify(e) {
        i("ui", "ui.notify");
      }
    ...
    core: {
      listGames() {
        return i("core.read", "core.listGames"), d("get_games");
      },
      listSnapshots(e) {
        return i("core.read", "core.listSnapshots"), d("get_snapshots", { gameId: e });
      },
      getGame(e) {
        return i("core.read", "core.getGame"), d("get_game_by_id", { gameId: e });
      },
      triggerBackup(e) {
        return i("core.backup", "core.triggerBackup"), d("backup_now", { gameId: e });
      }
    },
    events: {
      on(e, s) {
        i("events", "events.on"), q1(t, e, s);
      },
      off(e, s) {
        i("events", "events.off"), Y1(e, s);
      }
    },
    storage: {
      get() {
    ...
    music: {
      openLoginWindow() {
        return i("music", "music.openLoginWindow"), d("music_open_login_window");
      },
      loginQrKey() {
        return i("music", "music.loginQrKey"), d("music_login_qr_key");
      },
      loginQrCheck(e) {
        return i("music", "music.loginQrCheck"), d("music_login_qr_check", { key: e });
      },
      sendLoginCaptcha(e, s) {
        return i("music", "music.sendLoginCaptcha"), d("music_login_send_captcha", { phone: e, countrycode: s });
      },
      loginCellphone(e, s, b) {
        return i("music", "music.loginCellphone"), d("music_login_cellphone", { phone: e, captcha: s, countrycode: b });
      },
      loginStatus() {
        return i("music", "music.loginStatus"), d("music_login_status");
      },
      logout() {
        return i("music", "music.logout"), d("music_logout");
      },
      search(e, s) {
        return i("music", "music.search"), d("music_search", { keywords: e, limit: s });
      },
      userPlaylists() {
        return i("music", "music.userPlaylists"), d("music_user_playlists");
      },
      likedList() {
        return i("music", "music.likedList"), d("music_likelist");
      },
      likeSong(e, s) {
        return i("music", "music.likeSong"), d("music_like", { id: e, like: s });
      },
      subscribePlaylist(e, s) {
        return i("music", "music.subscribePlaylist"), d("music_playlist_subscribe", { id: e, subscribe: s });
      },
      recommendSongs() {
        return i("music", "music.recommendSongs"), d("music_recommend_songs");
      },
      topPlaylists() {
        return i("music", "music.topPlaylists"), d("music_toplists");
      },
      personalizedPlaylists() {
        return i("music", "music.personalizedPlaylists"), d("music_personalized_playlists");
      },
      searchPlaylists(e, s) {
        return i("music", "music.searchPlaylists"), d("music_playlist_search", { keywords: e, limit: s });
      },
      searchAlbums(e, s) {
        return i("music", "music.searchAlbums"), d("music_album_search", { keywords: e, limit: s });
      },
      searchArtists(e, s) {
        return i("music", "music.searchArtists"), d("music_artist_search", { keywords: e, limit: s });
      },
      albumSongs(e) {
        return i("music", "music.albumSongs"), d("music_album_songs", { id: e });
      },
      artistSongs(e) {
        return i("music", "music.artistSongs"), d("music_artist_songs", { id: e });
      },
      playlistTracks(e) {
        return i("music", "music.playlistTracks"), d("music_playlist_tracks", { id: e });
      },
      playlistTracksRange(e, s, b) {
        return i("music", "music.playlistTracksRange"), d("music_playlist_tracks_range", { id: e, start: s, count: b });
      },
      songUrl(e, s) {
        return i("music", "music.songUrl"), d("music_song_url", s ? { id: e, quality: s } : { id: e });
      },
      lyric(e) {
        return i("music", "music.lyric"), d("music_lyric", { id: e });
      },
      proxyPort() {
        return i("music", "music.proxyPort"), d("music_proxy_port");
      },
      async audioProxyUrl(e) {
        return i("music", "music.audioProxyUrl"), `http://127.0.0.1:${await d("music_proxy_port")}/audio?url=${encodeURIComponent(e)}`;
      },
      async coverProxyUrl(e) {
        return i("music", "music.coverProxyUrl"), e ? `http://127.0.0.1:${await d("music_proxy_port")}/cover?url=${encodeURIComponent(e)}` : "";
      },
      clearCoverCache() {
        return i("music", "music.clearCoverCache"), d("music_clear_cover_cache");
      }
    },
    bilibili: {
      account: {
        ...
        loginQrCheck(e) {
          return i("bilibili", "bilibili.account.loginQrCheck"), l("bilibili_login_qr_check", { key: e });
        },
        loginStatus() {
      ...
      home: {
        recommendVideos(e, s) {
          return i("bilibili", "bilibili.home.recommendVideos"), l("bilibili_recommend_videos", { page: e, refresh: s });
        },
        searchVideos(e, s, b) {
          return i("bilibili", "bilibili.home.searchVideos"), l("bilibili_search_videos", { keywords: e, page: s, refresh: b });
        },
        popularVideos(e, s) {
          return i("bilibili", "bilibili.home.popularVideos"), l("bilibili_popular_videos", { page: e, refresh: s });
        }
      },
      video: {
        detail(e) {
          return i("bilibili", "bilibili.video.detail"), l("bilibili_video_detail", e);
        },
        related(e) {
          return i("bilibili", "bilibili.video.related"), l("bilibili_related_videos", e);
        },
        openExternal(e) {
          return i("bilibili", "bilibili.video.openExternal"), l("bilibili_open_video", { bvid: e });
        }
      },
      playback: {
        proxyPort() {
        ...
        createPlayback(e) {
          return i("bilibili", "bilibili.playback.createPlayback"), l("bilibili_create_playback", e);
        },
        saveLocalProgress(e) {
          return i("bilibili", "bilibili.playback.saveLocalProgress"), l("bilibili_save_local_progress", e);
        },
        loadLocalProgress(e) {
          return i("bilibili", "bilibili.playback.loadLocalProgress"), l("bilibili_load_local_progress", e);
        },
        reportProgress(e) {
          return i("bilibili", "bilibili.playback.reportProgress"), l("bilibili_report_progress", e);
        }
      },
      danmaku: {
        list(e) {
          return i("bilibili", "bilibili.danmaku.list"), l("bilibili_danmaku_list", e);
        },
        segment(e) {
          return i("bilibili", "bilibili.danmaku.segment"), l("bilibili_danmaku_segment", e);
        },
        thumbup(e) {
          return i("bilibili", "bilibili.danmaku.thumbup"), l("bilibili_danmaku_thumbup", e);
        },
        report(e) {
          return i("bilibili", "bilibili.danmaku.report"), l("bilibili_danmaku_report", e);
        },
        recall(e) {
          return i("bilibili", "bilibili.danmaku.recall"), l("bilibili_danmaku_recall", e);
        },
        send(e) {
          return i("bilibili", "bilibili.danmaku.send"), l("bilibili_send_danmaku", e);
        }
      },
      comment: {
        list(e) {
          return i("bilibili", "bilibili.comment.list"), l("bilibili_comment_list", { ...e, oid: String(e.oid) });
        },
        replies(e) {
          return i("bilibili", "bilibili.comment.replies"), l("bilibili_comment_replies", { ...e, oid: String(e.oid) });
        },
        add(e) {
          return i("bilibili", "bilibili.comment.add"), l("bilibili_comment_add", { ...e, oid: String(e.oid) });
        },
        like(e) {
          return i("bilibili", "bilibili.comment.like"), l("bilibili_comment_like", { ...e, oid: String(e.oid) });
        },
        dislike(e) {
          return i("bilibili", "bilibili.comment.dislike"), l("bilibili_comment_dislike", { ...e, oid: String(e.oid) });
        },
        delete(e) {
          return i("bilibili", "bilibili.comment.delete"), l("bilibili_comment_delete", { ...e, oid: String(e.oid) });
        },
        top(e) {
          return i("bilibili", "bilibili.comment.top"), l("bilibili_comment_top", { ...e, oid: String(e.oid) });
        },
        report(e) {
          return i("bilibili", "bilibili.comment.report"), l("bilibili_comment_report", { ...e, oid: String(e.oid) });
        }
      },
      library: {
        historyList(e) {
          return i("bilibili", "bilibili.library.historyList"), l("bilibili_history_list", { page: e });
        },
        toViewList() {
          return i("bilibili", "bilibili.library.toViewList"), l("bilibili_toview_list");
        },
        addToView(e) {
          return i("bilibili", "bilibili.library.addToView"), l("bilibili_toview_add", e);
        },
        removeToView(e) {
          return i("bilibili", "bilibili.library.removeToView"), l("bilibili_toview_remove", e);
        },
        favoriteFolders(e) {
          return i("bilibili", "bilibili.library.favoriteFolders"), l("bilibili_favorite_folders", { rid: e });
        },
        favoriteItems(e, s) {
          return i("bilibili", "bilibili.library.favoriteItems"), l("bilibili_favorite_items", { mediaId: e, page: s });
        },
        favoriteVideo(e) {
      ...
      interaction: {
        state(e) {
          return i("bilibili", "bilibili.interaction.state"), l("bilibili_interaction_state", e);
        },
        like(e) {
          return i("bilibili", "bilibili.interaction.like"), l("bilibili_like_video", e);
        },
        coin(e) {
          return i("bilibili", "bilibili.interaction.coin"), l("bilibili_coin_video", e);
        },
        favorite(e) {
        ...
        toView(e) {
          return i("bilibili", "bilibili.interaction.toView"), l("bilibili_toview_video_interaction", e);
        },
        followOwner(e) {
          return i("bilibili", "bilibili.interaction.followOwner"), l("bilibili_follow_owner", e);
        },
        copyShareLink(e) {
          return i("bilibili", "bilibili.interaction.copyShareLink"), l("bilibili_copy_share_link", e);
        },
        openReport(e) {
          return i("bilibili", "bilibili.interaction.openReport"), l("bilibili_open_report", e);
        }
      },
      cache: {
        saveScreenshot(e) {
          return i("bilibili", "bilibili.cache.saveScreenshot"), l("bilibili_save_screenshot", e);
        },
        ...
        async coverProxyUrl(e) {
          return i("bilibili", "bilibili.cache.coverProxyUrl"), e ? `http://127.0.0.1:${await l("bilibili_proxy_port")}/bilibili/cover/${Ir(e)}?url=${encodeURIComponent(e)}` : "";
        }
      },
      ranking: {
        videos(e) {
          return i("bilibili", "bilibili.ranking.videos"), l("bilibili_ranking_videos", { rid: e });
        },
        weeks() {
          return i("bilibili", "bilibili.ranking.weeks"), l("bilibili_weekly_series_list");
        },
        weekDetail(e) {
          return i("bilibili", "bilibili.ranking.weekDetail"), l("bilibili_weekly_series_one", { number: e });
        },
        precious() {
      ...
      search: {
        suggest(e) {
          return i("bilibili", "bilibili.search.suggest"), l("bilibili_search_suggest", { keyword: e });
        },
        hotwords() {
      ...
      fav: {
        createFolder({ title: e }) {
          return i("bilibili", "bilibili.fav.createFolder"), l("bilibili_fav_folder_create", { title: e });
        },
        editFolder({ mediaId: e, title: s }) {
          return i("bilibili", "bilibili.fav.editFolder"), l("bilibili_fav_folder_edit", { mediaId: e, title: s });
        },
        deleteFolders({ mediaIds: e }) {
          return i("bilibili", "bilibili.fav.deleteFolders"), l("bilibili_fav_folder_delete", { mediaIds: e });
        },
        deleteResources({ mediaId: e, resources: s }) {
          return i("bilibili", "bilibili.fav.deleteResources"), l("bilibili_fav_resource_delete", { mediaId: e, resources: s });
        },
        moveResources({ srcMediaId: e, tarMediaId: s, resources: b }) {
          return i("bilibili", "bilibili.fav.moveResources"), l("bilibili_fav_resource_move", { srcMediaId: e, tarMediaId: s, resources: b });
        },
        copyResources({ srcMediaId: e, tarMediaId: s, resources: b }) {
          return i("bilibili", "bilibili.fav.copyResources"), l("bilibili_fav_resource_copy", { srcMediaId: e, tarMediaId: s, resources: b });
        },
        cleanResources({ mediaId: e }) {
          return i("bilibili", "bilibili.fav.cleanResources"), l("bilibili_fav_resource_clean", { mediaId: e });
        }
      },
      user: {
        space({ mid: e }) {
          return i("bilibili", "bilibili.user.space"), l("bilibili_user_space", { mid: e });
        },
        videos({ mid: e, page: s }) {
          return i("bilibili", "bilibili.user.videos"), l("bilibili_user_videos", { mid: e, page: s });
        },
        follow({ mid: e, follow: s }) {
          return i("bilibili", "bilibili.user.follow"), l("bilibili_user_follow", { mid: e, follow: s });
        }
      },
      season: {
        detail({ seasonId: e }) {
          return i("bilibili", "bilibili.season.detail"), l("bilibili_season_detail", { seasonId: e });
        },
        follow({ seasonId: e, follow: s }) {
          return i("bilibili", "bilibili.season.follow"), l("bilibili_season_follow", { seasonId: e, follow: s });
        },
        pgcTabs({ kind: e }) {
          return i("bilibili", "bilibili.season.pgcTabs"), l("bilibili_pgc_tabs", { kind: e });
        },
        pgcRank({ seasonType: e }) {
          return i("bilibili", "bilibili.season.pgcRank"), l("bilibili_pgc_rank", { seasonType: e });
        },
        followList({ page: e, cinema: s }) {
          return i("bilibili", "bilibili.season.followList"), l("bilibili_bangumi_follow_list", { page: e, cinema: s });
        }
      },
      live: {},
      dynamic: {
        all(e) {
          return i("bilibili", "bilibili.dynamic.all"), l("bilibili_dynamic_all", e);
        },
        detail(e) {
          return i("bilibili", "bilibili.dynamic.detail"), l("bilibili_dynamic_detail", e);
        },
        like(e) {
          return i("bilibili", "bilibili.dynamic.like"), l("bilibili_dynamic_like", e);
        },
        createText(e) {
          return i("bilibili", "bilibili.dynamic.createText"), l("bilibili_dynamic_create_text", e);
        },
        top(e) {
          return i("bilibili", "bilibili.dynamic.top"), l("bilibili_dynamic_top", e);
        },
        forwards(e) {
          return i("bilibili", "bilibili.dynamic.forwards"), l("bilibili_dynamic_forwards", e);
        }
      },
      message: {},
      note: {},
...
export {
  ...
  Qr as Toggle,
  Dr as apiVersion,
  ii as clearPluginDispose,
  ei as clearPluginRegistrations,
  si as createElement,
  ti as createPluginSdk,
  Jr as default,
  q as registeredPages,
  G as registeredSettingsSections,
  ri as runPluginDispose,
  ni as useCallback,
  ci as useContext,
  ui as useEffect,
  di as useRef,
